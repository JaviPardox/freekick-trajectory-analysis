...
time = np.linspace(0, 1.05, 100)

#INITIAL CONDITIONS
Vo = np.array([10,5,9]) #initial velocities
Ro = np.array([0,0,0]) #initial positions

#LIONEL MESSI TARGET
Rf = np.array([32,3.66,2.3]) 
...
wall_y_top = np.linspace(-0.5,2,50)
